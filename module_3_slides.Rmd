...
$e$ represents the things we don't understand that still influence $y$ (residual)

---

## Example

The basic R formula goes `y ~ x`
...
With the model object we use things like:
- <span class="func">summary</span>
- <span class="func">predict</span>
- <span class="func">coef</span>
- <span class="func">fitted</span>
- <span class="func">residual</span>
...
- except $y$ is now a binary or other indicator of class membership
...
There are many other metrics besides accuracy we could use

Depending on your situation you may prefer others
...
Creating model lists and apply functions to them
